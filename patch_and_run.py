...
PATCH_VERSION='1.5-translationfix'
...
def patch_extras(bundle_raw):
    ...
    for old,new,expected in [
        ('おーい','야!',1),('ゆいな','유이나',2),('かえる','귀가',1),('유령','귀신',2),('チッ','쳇',1)
    ]:
